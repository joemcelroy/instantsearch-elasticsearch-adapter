...
See this in action on CodeSandbox: [https://codesandbox.io/s/cloudflare-instantsearch-example-1duhn9?file=/index.html](https://codesandbox.io/s/github/algolia/instantsearch.js/tree/develop/examples/cloudflare-workers)
...
Easiest way is adding the InstantSearch.js library & ISES via a CDN:
...
<html>
  <head>
    <script src="https://cdn.jsdelivr.net/npm/@ises/client@1.2.0/dist/umd/index.global.js"></script>
