...
It is available as `@instantsearch-elasticsearch-api/api` on npm.

```sh
npm install @instantsearch-elasticsearch-api/api
```

Then import it in your project:

```js
import Client from "@instantsearch-elasticsearch-api/api";
```
